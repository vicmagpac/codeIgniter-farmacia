		...
		<div id="main-content">
			...
			<table id="table-example" class="table">
				...
				<tbody>
					...
					?>
						<tr class="gradeX">
							<td><?php echo $func->id_user ?></td>
							<td><?php echo $func->nome_user ?></td>
							<td><?php echo $func->telefone ?></td>
							<td><?php echo $func->sexo == 'M' ? 'Masculino' : 'Feminino' ?></td>
							<td><?php echo $func->nome_cidade ?></td>
							<td><?php echo $func->nome_estado ?></td>
							<td><?php echo anchor('index.php/funcionario/update/'.$func->id_user, 'Editar') ?> | <?php echo anchor('index.php/funcionario/delete/'.$func->id_user, 'Excluir') ?></td>
						</tr>
					<?php endforeach; ?>
				</tbody>
			</table>
			...
			<table id="table-example" class="table">
				<thead>
					<tr>
						<th><span style="font-size:18px;">Quantidade de Funcionarios Cadastrados: <?php echo $qtdFunc; ?></span></th>
					</tr>
				</thead>
			</table>		
