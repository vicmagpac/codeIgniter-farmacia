...
<body id="top">
	<div id="container">
		...
		<div id="main-content">
			...
			<?php endif; ?>
			<form id="validate-form" class="block-content form" action="<?php echo site_url('index.php/produto/cadastro'); ?>" method="post">
				<div class="_100">
				...
				<div class="_100">
					<p>
						...
						<select name="tipo" required>
							...
							<option value="GENÉRICOS">Genérico</option>
				...
				<div class="_100">
					<p><label for="descricao">Valor</label><input id="valor" name="valor" class="required" required type="text" /></p>
				</div>

				<div class="_100">
					<p><label for="descricao">Quantidade</label><input id="quantidade" name="quantidade" class="required" required type="text" /></p>
				</div>
				<div class="_100">
					<p>
