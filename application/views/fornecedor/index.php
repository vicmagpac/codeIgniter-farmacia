	...
	<div id="container">
			...
			<nav id="nav">
				<ul class="menu collapsible shadow-bottom">
					...
					<li>
						...
						<ul class="sub">
							<li><?php echo anchor('/index.php/relatorio/produtos', 'Relatório de Produtos', array('target' => '_blank'), array('target' => '_blank')); ?></li>	
		...
		<div id="main-content">
				...
				<tbody>
					...
					?>
						<tr class="gradeX">
							...
							<td><?php echo $for->nome ?></td>
							<td><?php echo $for->cnpj ?></td>
							<td><?php echo $for->telefone ?></td>
							<td><?php echo anchor('index.php/fornecedor/delete/'.$for->id, 'Excluir') ?></td>
						</tr>
					<?php endforeach; ?>
				</tbody>
			</table>
			...
			<table id="table-example" class="table">
				<thead>
					<tr>
						<th><span style="font-size:18px;">Quantidade de Fornecedores Cadastrados: <?php echo $qtdFor; ?></span></th>
					</tr>
				</thead>
			</table>		
